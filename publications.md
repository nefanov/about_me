...
29. Склонин И.А., Ефанов Н.Н., Подлесных Д.А. О гибридной генерации тестов для задачи сравнения инъективных отображений деревьев процессов в векторные пространства // Труды 63-й Всероссийской Научно-Практической Конференции МФТИ, Том ФПМИ, М. 2020.
...
31. N. Efanov, "On synthetic process trees reconstruction using graph-based operation restore model" // VII'th International Conference on Engineering and Telecommunication (EnT-2020), Moscow, 2020 [Accepted]
